  ...
  return (
    <Stack gap={2}>
      <Typography variant="body1" color="text.secondary">
        Connect this organization to GitHub so App Factory can provision repos, open issues, and run agents on your behalf.
      </Typography>
      ...
      <Card sx={{ border: 2, borderColor: 'primary.main', borderRadius: 2 }}>
        <CardContent>
          ...
          <Alert severity="info" icon={<AlertCircle size={18} />} sx={{ mb: 2 }}>
            ...
            <Typography variant="caption" color="text.secondary">
              App Factory creates repositories on the connected GitHub account. GitHub does not let integrations create repos on personal user accounts — pick (or create) a GitHub Org you administer when prompted.
            </Typography>
          </Alert>
